...
<html lang="zxx">
 ...
 while($rows = mysqli_fetch_array($query_res))
 	...
 	<table class="table table-bordered"  style="width: 40%;"> 
 			<thead><tr><th>USER ID:</th><td> <?php echo " $user_id"; ?></td></tr><br>
 					<tr>	<th>USER NAME:</th><td><?php echo " $username"; ?></td></tr>
 					<tr>	 <th>PHONE  NUMBER:</th><td><?php echo " $phone_number"; ?></td></tr>
 					<tr>	<th>EMAIL:</th><td><?php echo " $email"; ?></td></tr>	
 						<td colspan="2"><a  href="register_edit.php?user_id=<?php echo $user_id; ?>" class="btn btn-primary"  >EDIT PROFILE</a> <a href="index1.php" class="btn btn-secondary">CANCEL</a><br></td>
