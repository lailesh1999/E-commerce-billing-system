...
<html lang="zxx">
   ...
   <body>
      ...
      <section class="contact py-lg-4 py-md-3 py-sm-3 py-3">
         ...
         <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3"> ORDER DETAIL</h3>
...
<?php
  ...
  <!-- <div style="padding: 20px">   <div style="padding-left:20px;border: 2px solid blue;width: 30%;height:100%;"> -->
      <img src="admin/product_img/<?php echo $product_img;?>" width="100" height="100" /></td>
   <td><?php echo $product_name;?></b></td>
  <td> <b><?php echo $quantity;?></b></td>
   <td><b><?php echo $price;?></b></td>
   <td><b><?php echo $total_price;?></b></td></tr>
   <?php
}
?>
<td colspan="5" style="padding-left: 72%;"><b>GRAND TOTAL :<?php echo $grand_total;?></b></td>
</table>

<a href="view_invoice.php?invoice_id=<?php   echo $invoice_id; ?>" class="btn btn-secondary">VIEW INVOICE</a>
