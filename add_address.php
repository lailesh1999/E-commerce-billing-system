   ...
   <body>
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
               <ul class="navbar-nav ">
                   <li class="nav-item active">
                     ...
                     <li class="nav-item">
                        <a href="view_register.php" class="nav-link">VIEW PROFILE</a>
                     </li>
      ...
      <section class="contact py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">ADDRESS DETAILS</h3>
            <div class="contact-list-grid">
               <div class="card-body"n style="padding: 1%;">
  <form method="POST" action="add_address_process.php" enctype="multipart/form-data">
<div class="card" style="width: 30rem;">
      ...
      <div class="form-group">
        <label>ADDRESS</label>
            ...
            <input type="text" class="form-control"  name="mobile_number" required><br>
 <center><button type="submit" name="addaddress" class="btn btn-danger">SAVE</button></center>
